...
export default function EmployeeForm({ employeeData, onSubmit, isEdit = false }) {
  ...
  useEffect(() => {
    getFilters()
      .then((data) => {
        // data.departments có thể là mảng string hoặc mảng object {id, name}
  ...
  const handleSubmit = async (e) => {
    ...
    // Đảm bảo department_id và position_id là số nếu có giá trị
    const payload = {
      ...form,
  ...
  // Helper: render option cho select, hỗ trợ cả mảng string và object
